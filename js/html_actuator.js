...
HTMLActuator.prototype.updateScore = function (score) {
  ...
  if (difference > 0) {
    ...
    snd = new Audio("https://lekagh.github.io/Oispa-Sipsii/snd/pen/pencil_scribble0" + Math.floor(Math.random() * 3).toString() + ".ogg")
  ...
  {
    snd = new Audio("" + Math.floor(Math.random() * 3).toString() + ".ogg");
  }
...
HTMLActuator.prototype.goKatko = function () {
    ...
    messageElement.setAttribute('src',"");
    //messageElement.textContent = message;
    //var left = 'left: 37%;';
    //var top = 'top: 10%;';
